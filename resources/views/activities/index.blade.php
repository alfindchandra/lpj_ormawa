                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select id="lpjFilter" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    @foreach($activities as $activity)
                                        <tr class="hover:bg-gray-50" 
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @php
                                                    $statusConfig = [
                                                        'scheduled' => ['bg' => 'bg-blue-100', 'text' => 'text-blue-800', 'label' => 'Dijadwalkan'],
                                                        'ongoing' => ['bg' => 'bg-yellow-100', 'text' => 'text-yellow-800', 'label' => 'Berlangsung'],
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($activity->lpj)
                                                    ...
                                                    @endphp
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $lpjStatus['bg'] }} {{ $lpjStatus['text'] }}">
                                                        {{ $lpjStatus['label'] }}
                                                    </span>
                                                @else
