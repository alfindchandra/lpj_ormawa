        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900">Rp
                                        {{ number_format($activity->proposal->anggaran, 0, ',', '.') }}</p>
                                </div>
                                <div>
                                    <span class="text-gray-500">Jumlah Peserta:</span>
                                    <p class="font-semibold text-gray-900">
                                        {{ $activity->jumlah_peserta ?? 'Belum diisi' }}</p>
                                </div>
                            </div>

                            <div class="mt-4">
                                <a href="{{ route('proposals.show', $activity->proposal) }}"
                    ...
                    <!-- Update Status Form -->
                    @if((Auth::user()->role === 'ormawa' && Auth::id() === $activity->user_id) || Auth::user()->role === 'bem')
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form action="{{ route('activities.update-status', $activity) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="scheduled"
                                            {{ $activity->status === 'scheduled' ? 'selected' : '' }}>Dijadwalkan
                                        </option>
                                        <option value="ongoing" {{ $activity->status === 'ongoing' ? 'selected' : '' }}>
                                            Sedang Berlangsung</option>
                                        <option value="completed"
                                            {{ $activity->status === 'completed' ? 'selected' : '' }}>Selesai</option>
                                        <option value="cancelled"
                                            {{ $activity->status === 'cancelled' ? 'selected' : '' }}>Dibatalkan
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="jumlah_peserta" value="{{ $activity->jumlah_peserta }}"
                                        min="0"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Catatan
                                        Pelaksanaan</label>
                                    <textarea name="catatan_pelaksanaan" rows="3"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ $activity->catatan_pelaksanaan }}</textarea>
                                </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form action="{{ route('activities.upload-documentation', $activity) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">File (JPG, PNG, PDF -
                                        Max 5MB)</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="keterangan" placeholder="Contoh: Foto pembukaan acara"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div class="border rounded-lg overflow-hidden">
                                    ...
                                    <img src="{{ Storage::url($doc->file_path) }}" alt="{{ $doc->keterangan }}"
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-4 pb-2 border-b flex items-center justify-between">
                                ...
                                @endphp
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full {{ $lpjStatusColors[$activity->lpj->status] }}">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-semibold">Rp
                                            {{ number_format($activity->lpj->realisasi_anggaran, 0, ',', '.') }}</p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <a href="{{ Storage::url($activity->lpj->file_lpj) }}" target="_blank"
                            ...
                            <form action="{{ route('lpj.verify', $activity->lpj) }}" method="POST" class="mt-6">
                                @csrf
                                <textarea name="catatan_verifikasi" rows="2" placeholder="Catatan verifikasi (opsional)"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 mb-3"></textarea>

                                <div class="flex gap-3">
                                    <button type="submit" name="status" value="approved"
                                        class="flex-1 inline-flex justify-center items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                                        Setujui LPJ
                                    </button>
                                    <button type="submit" name="status" value="rejected"
                                        onclick="return confirm('Yakin ingin menolak LPJ ini?')"
                                        class="flex-1 inline-flex justify-center items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700">
                                        Tolak LPJ
                                    </button>
                                </div>
                            </form>
                    ...
                    @else
                    @if(Auth::user()->role === 'ormawa' && Auth::id() === $activity->user_id && $activity->status ===
                    'completed')
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-yellow-700 mb-4">Kegiatan sudah selesai. Silakan buat laporan
                                    pertanggungjawaban (LPJ).</p>
                                <a href="{{ route('lpj.create', $activity) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            'scheduled' => ['color' => 'blue', 'text' => 'Dijadwalkan', 'icon' => 'M8 7V3m8 4V3m-9
                            8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
                            'ongoing' => ['color' => 'yellow', 'text' => 'Sedang Berlangsung', 'icon' => 'M12 8v4l3
                            3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
                            'completed' => ['color' => 'green', 'text' => 'Selesai', 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0
                            ...
                            <div class="flex items-center p-4 bg-{{ $actStatus['color'] }}-50 rounded-lg">
                                <div class="flex-shrink-0">
                                    <svg class="h-8 w-8 text-{{ $actStatus['color'] }}-600" fill="none"
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center pb-2 border-b">
                                    ...
                                    <span
                                        class="font-semibold text-gray-900">{{ $activity->documentations->count() }}</span>
                                </div>
                                <div class="flex justify-between items-center pb-2 border-b">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="font-semibold text-gray-900">{{ $activity->created_at->format('d/m/Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
