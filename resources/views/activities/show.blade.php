        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Update Status Form -->
                    @if(Auth::user()->role === 'ormawa' && Auth::id() === $activity->user_id)
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <form action="{{ route('activities.update-status', $activity) }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="jumlah_peserta" value="{{ $activity->jumlah_peserta }}" min="0"
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <form action="{{ route('activities.upload-documentation', $activity) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">File (JPG, PNG, PDF - Max 5MB)</label>
                                    ...
                                    @foreach($activity->documentations as $doc)
                                        <div class="border rounded-lg overflow-hidden">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <a href="{{ Storage::url($doc->file_path) }}" target="_blank" class="text-xs text-blue-600 hover:text-blue-800">
                                                    Lihat
                                                </a>
                                            </div>
                                        </div>
                    ...
                    @else
                        @if(Auth::user()->role === 'ormawa' && Auth::id() === $activity->user_id && $activity->status === 'completed')
