            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('proposals.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label for="barang_diperlukan" class="block text-sm font-medium text-gray-700 mb-2">
                                Barang yang diperlukan <span class="text-red-500">*</span>
                            </label>
                            <textarea name="barang_diperlukan" id="barang_diperlukan" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Contoh: Proyektor, Sound System, Meja kursi, dll"
                                required>{{ old('barang_diperlukan') }}</textarea>
                            @error('barang_diperlukan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Sewa Tempat / Tempat -->
                        <div class="mb-6">
                            <label for="sewa_tempat" class="block text-sm font-medium text-gray-700 mb-2">
                                Sewa Tempat / Tempat <span class="text-red-500">*</span>
                            </label>
                            <textarea name="sewa_tempat" id="sewa_tempat" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Contoh: Aula Kampus (2 hari), Gedung X (1 hari), dll"
                                required>{{ old('sewa_tempat') }}</textarea>
                            @error('sewa_tempat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Jasa -->
                        <div class="mb-6">
                            <label for="jasa" class="block text-sm font-medium text-gray-700 mb-2">
                                Jasa <span class="text-red-500">*</span>
                            </label>
                            <textarea name="jasa" id="jasa" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Contoh: Jasa MC, Jasa Catering, Jasa Photography, dll"
                                required>{{ old('jasa') }}</textarea>
                            @error('jasa')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="bahan" id="bahan" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Contoh: Kertas banner, Tinta printer, Pita, Ballpoint, dll"
