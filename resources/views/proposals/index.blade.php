                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200" id="proposalsTable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50" data-status="{{ $proposal->status }}"
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        ...
                                        <div class="text-xs text-gray-500 mt-1">
                                            {{ Str::limit($proposal->deskripsi, 80) }}</div>
                                    </td>
                                    @if(Auth::user()->role !== 'ormawa')
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        'Pending'],
                                        'approved_bem' => ['bg' => 'bg-blue-100', 'text' => 'text-blue-800', 'label' =>
                                        'Approved BEM'],
                                        'approved_admin' => ['bg' => 'bg-green-100', 'text' => 'text-green-800', 'label'
                                        => 'Approved'],
