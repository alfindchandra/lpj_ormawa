                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200" id="proposalsTable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 search-row" data-status="{{ $proposal->status }}" data-ormawa="{{ $proposal->user->ormawa_name }}">
                                    <!-- Kolom Kode -->
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <div class="flex items-center">
                                            ...
                                            {{ $proposal->tanggal_mulai ? $proposal->tanggal_mulai->format('d/m/Y') : '-' }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-6 whitespace-nowrap text-sm font-medium flex items-center gap-3">
                                        <!-- Detail (Icon Mata) -->
