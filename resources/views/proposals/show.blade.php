        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    {{-- Aksi Hapus Proposal (Khusus Admin) --}}
                    @if(Auth::user()->role === 'admin')
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-red-100">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-1 text-red-700">Hapus Proposal</h3>
                            <p class="text-xs text-gray-500 mb-4">
                                Tindakan ini akan menghapus proposal beserta file yang telah diunggah secara permanen dan tidak dapat dibatalkan.
                            </p>
                            <form action="{{ route('proposals.destroy', $proposal) }}" method="POST"
                                onsubmit="return confirm('Yakin ingin menghapus proposal ini? Tindakan ini tidak dapat dibatalkan.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="w-full inline-flex justify-center items-center px-4 py-2 bg-red-600 rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 transition">
