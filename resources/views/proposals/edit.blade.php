                            ...
                            <div id="section-anggaran">
                                ...
                                <div id="cat-dana-sponsor" class="mt-5">
                                    <div class="rounded-lg border border-gray-200 overflow-hidden bg-white">
                                        ...
                                        <div class="p-4">
                                            <textarea name="dana_sponsor_keterangan" rows="2" class="w-full rounded-md border-gray-300 text-sm" placeholder="Rincian sumber dana sponsor (nama sponsor, bentuk dukungan, dll)">{{ old('dana_sponsor_keterangan', $proposal->dana_sponsor_keterangan) }}</textarea>
                                            <div class="mt-2 flex items-center gap-3">
                                                <label class="text-xs font-medium text-gray-600">Nominal Dana Sponsor (Rp)</label>
                                                <input type="number" name="dana_sponsor_biaya" id="dana_sponsor_biaya" class="flex-1 rounded-md border-gray-300 text-sm" min="0" placeholder="0" 
                                                    value="{{ old('dana_sponsor_biaya', $proposal->dana_sponsor_biaya ? round($proposal->dana_sponsor_biaya) : '') }}">
                                            </div>
                                ...
                                <div class="mt-5">
                                    <x-budget-category-table title="8. Dll" subtitle="Pengeluaran lain-lain yang belum tercakup kategori di atas" section="dll" 
                                        :items="old('dll_items', $proposal->dllItems->isNotEmpty() ? $proposal->dllItems->toArray() : $blankRow)" placeholder="Contoh: Biaya lain-lain" />
                                </div>
                            </div>
